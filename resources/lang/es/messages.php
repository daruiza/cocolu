...
return [   
    ...
    "welcomeContent" => "Cocolú es una pieza de software, desarrollada para facilitar la gestión y administración de un Restaurante/Bar, durante todas las etapas de la labor.",    
    "welcomeTittleOffer" => "¿Que Ofrece Cocolú?",
    "Multilanguage" => "Multilenguaje",
    "Multiaccess" => "Acceso Desde Cualquier Dispositivo",
    "RealTime" => "Información en Tiempo Real",
    "inventoryManagement" => "Manejo de Inventario",
    ...
    "categoryManagement" => "Manejo de Categorias",
    "invoiceManager"=>"Manejo de Facturación",
    "expenseManager"=>"Manejo de Gastos",
    "costManager"=>"Manejo de Costos",
    "profitMarginsManager"=>"Margenes de Ganancia",
    "ordersAndService"=>"Ordenes y Servicios",
    "waiterManagement"=>"Manejo de Meseros",
    "LaborClosure"=>"Manejo de Cierres de Labor",
    "reports" => "Reportes e Informes",
    "configStoreManagement" => "Configuración de Bar",
    "nameDistribution" => "Nombre del Bar",
