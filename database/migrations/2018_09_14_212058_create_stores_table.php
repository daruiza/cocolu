...
class CreateStoresTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('stores', function (Blueprint $table) {
            ...
            $table->string('label',1024)->nullable()->default('{"table":{"menu":"page","TableHeight":"125","icon":"fas fa-list","selectTable":"lemonchiffon","serviceOpenTable":"sandybrown","colorRow":"gainsboro"},"order":{"OrderNew":"aliceblue","OrderOK":"cadetblue","OrderPay":"cornflowerblue","OrderCancel":"slategrey"}}');
