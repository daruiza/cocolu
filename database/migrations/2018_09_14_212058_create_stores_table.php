...
class CreateStoresTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('stores', function (Blueprint $table) {
            ...
            $table->string('label')->nullable()->default('{"menu":"page","icon":"fas fa-list","selectTable":"lemonchiffon","serviceOpenTable":"sandybrown","colorRow":"gainsboro","OrderStatusOne":"cadetblue"}');
