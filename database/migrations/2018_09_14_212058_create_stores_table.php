...
class CreateStoresTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('stores', function (Blueprint $table) {
            ...
            $table->string('label')->nullable()->default('{"menu":"page","TableHeight":"125","icon":"fas fa-list","selectTable":"lemonchiffon","serviceOpenTable":"sandybrown","colorRow":"gainsboro","OrderStatusOne":"aliceblue","OrderOK":"cadetblue"}');
