...
class OptionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
		...
		\DB::table('options')->insert(array(
			'name'=>'drag',			
			'label'=>'{"menu":"page","method":"get","icon":"fas fa-arrows-alt","maticon":"fiber_manual_record"}',
			'module_id'=>6
			)
		);
		...
		\DB::table('options')->insert(array(
			'name'=>'service',			
			'label'=>'{"menu":"page","method":"get","icon":"fas fa-clipboard","maticon":"fiber_manual_record"}',
			'module_id'=>6			
			)
		);	
		...
		\DB::table('options')->insert(array(
			'name'=>'changepassword',			
			'label'=>'{"menu":"page","method":"post","icon":"fas fa-times-circle","maticon":"fiber_manual_record"}',
			'module_id'=>8	
			)
		);
		...
		\DB::table('options')->insert(array(
			'name'=>'editstock',			
			'label'=>'{"menu":"page","method":"get","icon":"fas fa-boxes","maticon":"fiber_manual_record"}',
			'module_id'=>9	
			)
		);
